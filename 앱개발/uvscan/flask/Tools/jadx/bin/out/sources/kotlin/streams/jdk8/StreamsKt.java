...
public final class StreamsKt {
    ...
    public static final <T> Stream<T> asStream(final Sequence<? extends T> sequence) {
        ...
        Stream<T> stream = StreamSupport.stream(new Supplier() { // from class: kotlin.streams.jdk8.StreamsKt$$ExternalSyntheticLambda0
            ...
            public final Object get() {
                Spliterator m1359asStream$lambda4;
                m1359asStream$lambda4 = StreamsKt.m1359asStream$lambda4(Sequence.this);
                return m1359asStream$lambda4;
            }
        }, 16, false);
    ...
    public static final Spliterator m1359asStream$lambda4(Sequence this_asStream) {
