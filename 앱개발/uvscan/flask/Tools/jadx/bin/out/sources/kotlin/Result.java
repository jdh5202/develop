...
public final class Result<T> implements Serializable {
    ...
    public static boolean m66equalsimpl(Object obj, Object obj2) {
        return (obj2 instanceof Result) && Intrinsics.areEqual(obj, ((Result) obj2).m74unboximpl());
    }
    ...
    public static final boolean m72isSuccessimpl(Object obj) {
        return !(obj instanceof Failure);
    }

    /* renamed from: isFailure-impl  reason: not valid java name */
    public static final boolean m71isFailureimpl(Object obj) {
        return obj instanceof Failure;
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* renamed from: getOrNull-impl  reason: not valid java name */
    private static final T m69getOrNullimpl(Object obj) {
        if (m71isFailureimpl(obj)) {
            return null;
        }
        return obj;
    }
    ...
    public static final class Companion {
        ...
        private final <T> Object success(T t) {
            return Result.m65constructorimpl(t);
        }

        private final <T> Object failure(Throwable exception) {
            Intrinsics.checkNotNullParameter(exception, "exception");
            return Result.m65constructorimpl(ResultKt.createFailure(exception));
        }
    }
