...
final /* synthetic */ class ChannelsKt__ChannelsKt {
    ...
    public static final <E> Object trySendBlocking(SendChannel<? super E> sendChannel, E e) {
        Object mo1554trySendJP2dKIU = sendChannel.mo1554trySendJP2dKIU(e);
        if (!(mo1554trySendJP2dKIU instanceof ChannelResult.Failed)) {
            Unit unit = (Unit) mo1554trySendJP2dKIU;
            return ChannelResult.Companion.m1574successJP2dKIU(Unit.INSTANCE);
        }
        return ((ChannelResult) BuildersKt.runBlocking$default(null, new ChannelsKt__ChannelsKt$trySendBlocking$2(sendChannel, e, null), 1, null)).m1571unboximpl();
    }
    ...
    public static final <E> void sendBlocking(SendChannel<? super E> sendChannel, E e) {
        if (ChannelResult.m1569isSuccessimpl(sendChannel.mo1554trySendJP2dKIU(e))) {
            return;
        }
