...
public final class DelayKt {
    ...
    */
    ...
    public static final Object m1536delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object delay = delay(m1537toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m1537toDelayMillisLRDsOJo(long j) {
        if (Duration.m1379compareToLRDsOJo(j, Duration.Companion.m1482getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m1398getInWholeMillisecondsimpl(j), 1L);
        }
        return 0L;
    }
}
