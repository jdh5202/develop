...
final class ReceiveChannel$onReceiveOrNull$1$registerSelectClause1$1 extends SuspendLambda implements Function2<ChannelResult<? extends E>, Continuation<? super R>, Object> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object obj, Object obj2) {
        return m1575invokeWpGqRn0(((ChannelResult) obj).m1571unboximpl(), (Continuation) obj2);
    }

    /* renamed from: invoke-WpGqRn0  reason: not valid java name */
    public final Object m1575invokeWpGqRn0(Object obj, Continuation<? super R> continuation) {
        return ((ReceiveChannel$onReceiveOrNull$1$registerSelectClause1$1) create(ChannelResult.m1559boximpl(obj), continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            Object m1571unboximpl = ((ChannelResult) this.L$0).m1571unboximpl();
            Throwable m1563exceptionOrNullimpl = ChannelResult.m1563exceptionOrNullimpl(m1571unboximpl);
            if (m1563exceptionOrNullimpl != null) {
                throw m1563exceptionOrNullimpl;
            }
            Function2<E, Continuation<? super R>, Object> function2 = this.$block;
            Object m1564getOrNullimpl = ChannelResult.m1564getOrNullimpl(m1571unboximpl);
            this.label = 1;
            obj = function2.invoke(m1564getOrNullimpl, this);
