...
public final class MeasureTimeKt {
    public static final long measureTime(Function0<Unit> block) {
        ...
        long m1517markNowz9LOYto = TimeSource.Monotonic.INSTANCE.m1517markNowz9LOYto();
        block.invoke();
        return TimeSource.Monotonic.ValueTimeMark.m1520elapsedNowUwyO8pc(m1517markNowz9LOYto);
    }
    ...
    public static final long measureTime(TimeSource.Monotonic monotonic, Function0<Unit> block) {
        ...
        Intrinsics.checkNotNullParameter(block, "block");
        long m1517markNowz9LOYto = monotonic.m1517markNowz9LOYto();
        block.invoke();
        return TimeSource.Monotonic.ValueTimeMark.m1520elapsedNowUwyO8pc(m1517markNowz9LOYto);
    }
    ...
    public static final <T> TimedValue<T> measureTimedValue(Function0<? extends T> block) {
        Intrinsics.checkNotNullParameter(block, "block");
        return new TimedValue<>(block.invoke(), TimeSource.Monotonic.ValueTimeMark.m1520elapsedNowUwyO8pc(TimeSource.Monotonic.INSTANCE.m1517markNowz9LOYto()), null);
    }
    ...
    public static final <T> TimedValue<T> measureTimedValue(TimeSource.Monotonic monotonic, Function0<? extends T> block) {
        Intrinsics.checkNotNullParameter(monotonic, "<this>");
        Intrinsics.checkNotNullParameter(block, "block");
        return new TimedValue<>(block.invoke(), TimeSource.Monotonic.ValueTimeMark.m1520elapsedNowUwyO8pc(monotonic.m1517markNowz9LOYto()), null);
    }
}
