...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            m65constructorimpl = Result.m65constructorimpl(property == null ? null : Boolean.valueOf(Boolean.parseBoolean(property)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            m65constructorimpl = Result.m65constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = Result.m71isFailureimpl(m65constructorimpl) ? null : m65constructorimpl;
    ...
    public static final void m1576installSignalHandler$lambda1(Signal signal) {
