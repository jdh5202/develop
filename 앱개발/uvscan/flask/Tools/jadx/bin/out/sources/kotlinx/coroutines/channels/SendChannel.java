...
public interface SendChannel<E> {
    ...
    Object mo1554trySendJP2dKIU(E e);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) {
            ...
            if (ChannelResult.m1569isSuccessimpl(mo1554trySendJP2dKIU)) {
                return true;
            }
            Throwable m1563exceptionOrNullimpl = ChannelResult.m1563exceptionOrNullimpl(mo1554trySendJP2dKIU);
