...
public interface TimeMark {
    ...
    TimeMark mo1373minusLRDsOJo(long j);

    /* renamed from: plus-LRDsOJo */
    TimeMark mo1374plusLRDsOJo(long j);
    ...
    public static final class DefaultImpls {
        ...
        public static TimeMark m1516plusLRDsOJo(TimeMark timeMark, long j) {
            return new AdjustedTimeMark(timeMark, j, null);
        }

        /* renamed from: minus-LRDsOJo  reason: not valid java name */
        public static TimeMark m1515minusLRDsOJo(TimeMark timeMark, long j) {
            return timeMark.mo1374plusLRDsOJo(Duration.m1432unaryMinusUwyO8pc(j));
        }

        public static boolean hasPassedNow(TimeMark timeMark) {
            return !Duration.m1413isNegativeimpl(timeMark.mo1372elapsedNowUwyO8pc());
        }
