        ...
        try {
            ...
            if (job != null && !job.isActive()) {
                ...
                if (DebugKt.getRECOVER_STACK_TRACES() && (continuation instanceof CoroutineStackFrame)) {
                    ...
                    continuation.resumeWith(Result.m65constructorimpl(ResultKt.createFailure(cancellationException)));
                }
                cancellationException = cancellationException2;
                continuation.resumeWith(Result.m65constructorimpl(ResultKt.createFailure(cancellationException)));
            } else if (exceptionalResult$kotlinx_coroutines_core != null) {
                Result.Companion companion2 = Result.Companion;
                continuation.resumeWith(Result.m65constructorimpl(ResultKt.createFailure(exceptionalResult$kotlinx_coroutines_core)));
            } else {
                T successfulResult$kotlinx_coroutines_core = getSuccessfulResult$kotlinx_coroutines_core(takeState$kotlinx_coroutines_core);
                Result.Companion companion3 = Result.Companion;
                continuation.resumeWith(Result.m65constructorimpl(successfulResult$kotlinx_coroutines_core));
            }
            ...
            handleFatalException(null, Result.m68exceptionOrNullimpl(m65constructorimpl2));
        } catch (Throwable th2) {
            try {
                ...
                m65constructorimpl = Result.m65constructorimpl(ResultKt.createFailure(th3));
            }
            handleFatalException(th2, Result.m68exceptionOrNullimpl(m65constructorimpl));
        }
    }
