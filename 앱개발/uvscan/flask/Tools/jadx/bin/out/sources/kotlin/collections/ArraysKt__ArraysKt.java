        ...
        for (int i = 0; i < length; i++) {
            ...
            if (t != t2) {
                ...
                if ((t instanceof Object[]) && (t2 instanceof Object[])) {
                    ...
                    if (!UArraysKt.m631contentEqualskV0jMPg(((UByteArray) t).m149unboximpl(), ((UByteArray) t2).m149unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof UShortArray) && (t2 instanceof UShortArray)) {
                    if (!UArraysKt.m628contentEqualsFGO6Aew(((UShortArray) t).m409unboximpl(), ((UShortArray) t2).m409unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof UIntArray) && (t2 instanceof UIntArray)) {
                    if (!UArraysKt.m629contentEqualsKJPZfPQ(((UIntArray) t).m227unboximpl(), ((UIntArray) t2).m227unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof ULongArray) && (t2 instanceof ULongArray)) {
                    if (!UArraysKt.m633contentEqualslec5QzE(((ULongArray) t).m305unboximpl(), ((ULongArray) t2).m305unboximpl())) {
                        return false;
                    }
    ...
    private static final <T> void contentDeepToStringInternal$ArraysKt__ArraysKt(T[] tArr, StringBuilder sb, List<Object[]> list) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (t == null) {
                ...
                sb.append(UArraysKt.m645contentToString2csIQuQ(uByteArray != null ? uByteArray.m149unboximpl() : null));
            } else if (t instanceof UShortArray) {
                UShortArray uShortArray = (UShortArray) t;
                sb.append(UArraysKt.m649contentToStringd6D3K8(uShortArray != null ? uShortArray.m409unboximpl() : null));
            } else if (t instanceof UIntArray) {
                UIntArray uIntArray = (UIntArray) t;
                sb.append(UArraysKt.m648contentToStringXUkPCBk(uIntArray != null ? uIntArray.m227unboximpl() : null));
            } else if (t instanceof ULongArray) {
                ULongArray uLongArray = (ULongArray) t;
                sb.append(UArraysKt.m651contentToStringuLth9ew(uLongArray != null ? uLongArray.m305unboximpl() : null));
            } else {
